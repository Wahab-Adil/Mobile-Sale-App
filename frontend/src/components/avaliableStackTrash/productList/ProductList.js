...
const ProductList = ({ products, isLoading }) => {
  ...
  const DeleteWithAllBelongsSales = (id) => {
    confirmAlert({
      title: "Delete Product With All Belong Sales",
      message: "Are you sure you want to delete this product With All Sales.",
      buttons: [
        {
          label: "Delete",
          onClick: () => delTrashItem(id),
                  ...
                  return (
                    <tr key={_id}>
                      ...
                      <td style={{ textAlign: "center" }} className="icons">
                        ...
                        <span title="delete with Belong Sales">
                          <FcFullTrash
                            size={20}
                            color={"red"}
                            onClick={() => DeleteWithAllBelongsSales(_id)}
                          />
                        </span>
                      </td>
                    </tr>
